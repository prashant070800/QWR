...
class Profile(CreatedUpdatedBaseModel):
...
class Call(CreatedUpdatedBaseModel):
...
class TranscriptTurn(CreatedUpdatedBaseModel):
    id = models.BigAutoField(primary_key=True)
...
class Summary(CreatedUpdatedBaseModel):
    id = models.BigAutoField(primary_key=True)
